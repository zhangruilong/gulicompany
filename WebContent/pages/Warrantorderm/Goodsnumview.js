function goodsnumview(Warrantoutstore,ordermselections) {
	var Goodsnumviewclassify = "goodsnumview";
	...
	var selectgridWindow2 = new Ext.Window({
		layout : 'fit', // 设置窗口布局模式
		width : 620, // 窗口宽度
...
//		        			    ,'warrantoutodm' : ordermselections[0].get("ordermid")
//		        			    ,'idwarrantout' : newid
				                }); 
							Warrantoutstore.insert(Warrantoutstore.getCount(), p);
							selectgridWindow2.close();
//							var newid = getNewId();
//							var json = "[{'warrantoutstore' : '"+selectRows[0].get("goodsnumstore")+
//							"','warrantoutgoods':'"+selectRows[0].get("goodsnumgoods")+
//							"','warrantoutnum':'"+1+
////							"','warrantoutgtype':'"+selectRows[0].get("goodsnumnum")+
//							"','warrantoutgcode':'"+selectRows[0].get("goodscode")+
//							"','warrantoutgname':'"+selectRows[0].get("goodsname")+
//							"','warrantoutgunits':'"+selectRows[0].get("goodsunits")+
////							"','warrantoutordnote':'"+selectRows[0].get("storehousename")+
//							"','warrantoutodm':'"+ ordermselections[0].get("ordermid")+
//							"','idwarrantout':'"+newid+
//	        			    "'}]";
//							Ext.Ajax.request({
//								url : basePath + "WarrantoutAction.do?method=insAll",
//								method : 'POST',
//								params : {
//									json : json
//								},
