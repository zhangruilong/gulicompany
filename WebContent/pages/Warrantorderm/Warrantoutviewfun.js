		...
		buttons : [
					{
						...
						handler : function() {
							...
							Ext.getCmp('Warrantordermordermcusshop').setValue(selectRows[0].get("customershop"));
							Ext.getCmp('Warrantordermordermcustomer').setValue(selectRows[0].get("customerid"));
