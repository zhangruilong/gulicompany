		...
		buttons : [
					{
						...
						handler : function() {
							...
							Ext.getCmp('Warrantoutviewgoodscode').setValue(selectRows[0].get("goodscode"));
							Ext.getCmp('Warrantoutviewgoodsname').setValue(selectRows[0].get("goodsname"));
							Ext.getCmp('Warrantoutviewgoodsunits').setValue(selectRows[0].get("goodsunits"));
