		...
		buttons : [
					{
						...
						handler : function() {
							...
							Ext.getCmp('Largecuspriceviewgoodscode').setValue(selectRows[0].get("goodscode"));
							Ext.getCmp('Largecuspriceviewgoodsname').setValue(selectRows[0].get("goodsname"));
							Ext.getCmp('Largecuspriceviewgoodsunits').setValue(selectRows[0].get("goodsunits"));
							Ext.getCmp('Largecuspriceviewgoodsid').setValue(selectRows[0].get("goodsid"));
					...
					handler : function() {
						if (_form.form.isValid()) {
							...
							_form.form.submit({
								...
								params : {//改
									json : json,
									goodsid : Ext.getCmp('Largecuspriceviewgoodsid').getValue()
								},
