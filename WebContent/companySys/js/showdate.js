...
function Calendar_Modif(y,m,d)				//月份
{
if(m<1){m=12;y=y-1;}
if(m>12){m=1;y=y+1;}
...
function Calendar(obj,obj2)		//日历
{
var p=Calendar_obj=document.getElementById(obj);		//通过传入的id得到节点
Calendar_obj2=document.getElementById(obj2);
var re=/\d{4}-\d{2}-\d{2}/;							//年月日的格式
var arr,Sdate;
