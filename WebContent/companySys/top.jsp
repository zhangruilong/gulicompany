	...
	function play() {
		...
		function doGoods(){
			...
			menu_body.html("<ul class='nav'>"
			        ...
			        +"</li>"
			        +"<li class='nav__item'>"
			        +"<a href=allCarnivalGoods.action?bkgoodscompany="+'<%=loginInfo.getCompanyid() %>'+"&bkgoodstype=秒杀  target='main' class='nav__item-link'>"
			        +"<span class='nav__item-text'>秒杀专区</span>"
			        +"</a>   "
			        +"</li>"
			        +"<li class='nav__item'>"
			        +"<a href=allCarnivalGoods.action?bkgoodscompany="+'<%=loginInfo.getCompanyid() %>'+"&bkgoodstype=买赠  target='main' class='nav__item-link'>"
			        ...
			        +"</li>"
			        +"<li class='nav__item'>"
			        +"<a href=allCarnivalGoods.action?bkgoodscompany="+'<%=loginInfo.getCompanyid() %>'+"&bkgoodstype=组合  target='main' class='nav__item-link'>"
